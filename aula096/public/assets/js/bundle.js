...
function gera() {
  var senha = (0, _geradores["default"])(qtdCaracteres.value, chkMaiusculas.checked, chkMinusculas.checked, chkNumeros.checked, chkSimbolos.checked);
...
var rand = function rand(mix, max) {
